    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Start writing your book today</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input id="password" type={showPass ? 'text' : 'password'} placeholder="••••••••" className="pl-10 pr-10" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} />
